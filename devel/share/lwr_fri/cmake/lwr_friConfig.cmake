...
if("TRUE" STREQUAL "TRUE")
  set(lwr_fri_SOURCE_PREFIX /home/nyuad/catkin_ws/src/kuka-lwr-ros/kuka_lwr/lwr_fri)
  set(lwr_fri_DEVEL_PREFIX /home/nyuad/catkin_ws/devel)
  set(lwr_fri_INSTALL_PREFIX "")
  set(lwr_fri_PREFIX ${lwr_fri_DEVEL_PREFIX})
else()
  set(lwr_fri_SOURCE_PREFIX "")
  set(lwr_fri_DEVEL_PREFIX "")
  set(lwr_fri_INSTALL_PREFIX /home/nyuad/catkin_ws/install)
...
if(NOT "/home/nyuad/catkin_ws/devel/include;/home/nyuad/catkin_ws/src/kuka-lwr-ros/kuka_lwr/lwr_fri/include " STREQUAL " ")
  set(lwr_fri_INCLUDE_DIRS "")
  set(_include_dirs "/home/nyuad/catkin_ws/devel/include;/home/nyuad/catkin_ws/src/kuka-lwr-ros/kuka_lwr/lwr_fri/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'ashukla <ashukla@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'lwr_fri' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nyuad/catkin_ws/src/kuka-lwr-ros/kuka_lwr/lwr_fri/${idir}'.  ${_report}")
    endif()
...
set(lwr_fri_EXPORTED_TARGETS "lwr_fri_generate_messages_cpp;lwr_fri_generate_messages_eus;lwr_fri_generate_messages_lisp;lwr_fri_generate_messages_nodejs;lwr_fri_generate_messages_py")
...
set(depends "message_runtime;fri_library_ros;lwr_console")
foreach(depend ${depends})
  ...
  _list_append_deduplicate(lwr_fri_EXPORTED_TARGETS ${${lwr_fri_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "lwr_fri-msg-extras.cmake")
