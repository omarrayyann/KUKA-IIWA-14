...
if("TRUE" STREQUAL "TRUE")
  set(lwr_controllers_SOURCE_PREFIX /home/nyuad/catkin_ws/src/kuka-lwr-ros/kuka_lwr/lwr_controllers)
  set(lwr_controllers_DEVEL_PREFIX /home/nyuad/catkin_ws/devel)
  ...
  set(lwr_controllers_INSTALL_PREFIX /home/nyuad/catkin_ws/install)
...
if(NOT "/home/nyuad/catkin_ws/devel/include;/home/nyuad/catkin_ws/src/kuka-lwr-ros/kuka_lwr/lwr_controllers/include " STREQUAL " ")
  set(lwr_controllers_INCLUDE_DIRS "")
  set(_include_dirs "/home/nyuad/catkin_ws/devel/include;/home/nyuad/catkin_ws/src/kuka-lwr-ros/kuka_lwr/lwr_controllers/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'Guillaume de Chambrier <chambrierg@gmail.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'lwr_controllers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nyuad/catkin_ws/src/kuka-lwr-ros/kuka_lwr/lwr_controllers/${idir}'.  ${_report}")
    endif()
...
set(lwr_controllers_EXPORTED_TARGETS "lwr_controllers_generate_messages_cpp;lwr_controllers_generate_messages_eus;lwr_controllers_generate_messages_lisp;lwr_controllers_generate_messages_nodejs;lwr_controllers_generate_messages_py;lwr_controllers_gencfg")
...
set(depends "controller_interface;control_msgs;control_toolbox;realtime_tools;urdf;forward_command_controller;kdl_parser;message_runtime;robot_motion_generation;passive_ds_control;lwr_hw")
foreach(depend ${depends})
  ...
  _list_append_deduplicate(lwr_controllers_EXPORTED_TARGETS ${${lwr_controllers_dep}_EXPORTED_TARGETS})
endforeach()
